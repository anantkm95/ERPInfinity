...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - E-Commerce Order Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for E-Commerce Order Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity E-Commerce Order Service v1");
