...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - Inventory & Stock Movement Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for Inventory & Stock Movement Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity Inventory & Stock Movement Service v1");
