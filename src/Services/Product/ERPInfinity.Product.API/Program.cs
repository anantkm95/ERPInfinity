...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - Product & Catalog Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for Product & Catalog Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity Product & Catalog Service v1");
