...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - Notification & Alerts Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for Notification & Alerts Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity Notification & Alerts Service v1");
