...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - Analytics & Reporting Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for Analytics & Reporting Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity Analytics & Reporting Service v1");
