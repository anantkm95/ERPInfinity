...
namespace ERPInfinity.Pricing.API.Controllers;
...
{
    /// <summary>
    /// Health check endpoint for Pricing & Promotions Service.
    /// </summary>
    [HttpGet("health")]
    public IActionResult HealthCheck()
    {
        ...
        {
            status = "Healthy",
            service = "ERPInfinity.Pricing",
            timestamp = DateTime.UtcNow
        });
    }

    /// <summary>
    /// Retrieves summary status for Pricing & Promotions Service (Requires Scope / Permission Policy 'InternalServiceOnly').
    /// </summary>
    [HttpGet]
    ...
    public IActionResult GetSummary()
    {
        return Ok(new
        {
            service = "Pricing & Promotions Service",
