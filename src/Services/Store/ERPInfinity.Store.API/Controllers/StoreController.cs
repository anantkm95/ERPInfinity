...
namespace ERPInfinity.Store.API.Controllers;
...
{
    /// <summary>
    /// Health check endpoint for Store & POS Terminals Service.
    /// </summary>
    [HttpGet("health")]
    public IActionResult HealthCheck()
    {
        ...
        {
            status = "Healthy",
            service = "ERPInfinity.Store",
            timestamp = DateTime.UtcNow
        });
    }

    /// <summary>
    /// Retrieves summary status for Store & POS Terminals Service (Requires Scope / Permission Policy 'InternalServiceOnly').
    /// </summary>
    [HttpGet]
    ...
    public IActionResult GetSummary()
    {
        return Ok(new
        {
            service = "Store & POS Terminals Service",
