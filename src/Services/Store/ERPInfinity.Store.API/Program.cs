...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - Store & POS Terminals Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for Store & POS Terminals Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity Store & POS Terminals Service v1");
