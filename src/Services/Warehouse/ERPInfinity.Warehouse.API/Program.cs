...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - Warehouse & Fulfillment Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for Warehouse & Fulfillment Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity Warehouse & Fulfillment Service v1");
