...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - Payment & Settlement Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for Payment & Settlement Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity Payment & Settlement Service v1");
