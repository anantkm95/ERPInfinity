...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - Sales & POS Billing Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for Sales & POS Billing Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity Sales & POS Billing Service v1");
