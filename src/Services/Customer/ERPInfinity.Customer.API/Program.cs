...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - Customer & CRM Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for Customer & CRM Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity Customer & CRM Service v1");
