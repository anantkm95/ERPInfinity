...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - Finance & General Ledger Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for Finance & General Ledger Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity Finance & General Ledger Service v1");
