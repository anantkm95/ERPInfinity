...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "ERPInfinity - Purchase & Supplier Service Microservice API",
        Version = "v1",
        Description = "Scope-Protected Microservice API for Purchase & Supplier Service in ERPInfinity Architecture.",
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ERPInfinity Purchase & Supplier Service v1");
